...
<Section isThin>
    ...
    <p>
        ...
        and we'll be voting on the next year of LiTHe Hax. One thing that'll be
...
<Section isThin>
    <div class="past-event">
        ...
        <p>
            Foo Café and LiTHe Hax recently teamed up for a cybersecurity
            evening focused on Capture the Flag challenges. The event featured a
            brief introduction, a problem-solving lecture, and a chance to
            network over food and drinks with others passionate about
            cybersecurity.
        </p>
...
<Section isThin>
    <div class="past-event">
        ...
        <p>
            The LiTHe Hax LiU CTF was an exciting Capture the Flag competition
            held on March 8. We hosted this event to promote cybersecurity
            awareness within the student community, combining both relevance and
            fun.
        </p>
        <p>
            A total of 18 teams competed, each consisting of 2–5 participants.
            Free food was provided to all participants.
        </p>
...
<Section isThin>
    <div class="past-event">
        ...
        <p>
            We held a workshop in preparation for our CTF. During the workshop,
            we explained and showcased example challenges that resembled the
            actual CTF challenges.
        </p>
        <p>
            There were 80 available seats, and those who registered were
            provided free food, sponsored by the companies below.
        </p>
        ...
        <p>
            ...
            <DocumentLink
                class="workshop"
                link={`${base}/documents/workshop.zip`}
            />
        </p>
        <p>
